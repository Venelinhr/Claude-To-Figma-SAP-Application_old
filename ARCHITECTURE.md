...
| **"Component not in registry"** | Component missing from `knowledge/components/registry/` | Add schema file, then run `node build/build-registry-bundle.js` to regenerate the bundle (do NOT hand-edit `code.js`) — see `/sap-registry-update` |
