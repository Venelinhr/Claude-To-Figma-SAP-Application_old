...
echo -e "${GREEN}═══════════════════════════════════════════════════${NC}"
echo ""
echo "  ┌─ STEP 1 — Open the canonical reference file ──────────────┐"
echo "  │  In Figma: File → Open from computer                       │"
echo "  │  Select: $SKILL_DIR/docs/canonical-screens/                │"
echo "  │          'Claude to Figma SAP Application.fig'             │"
echo "  │  This is your ground truth — every build clones from here. │"
echo "  └────────────────────────────────────────────────────────────┘"
echo ""
echo "  ┌─ STEP 2 — Connect SAP Web UI Kit library ─────────────────┐"
...
echo "  └────────────────────────────────────────────────────────────┘"
echo ""
echo "  ┌─ STEP 5 — Restart Claude Code ────────────────────────────┐"
echo "  │  Run: claude                                                │"
